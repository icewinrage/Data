...
-- Хранилище истории смертей
local DeathHistory = {}
local DeathCounter = 0

-- Настройки (будут обновляться через UI)
local Settings = {
    Rage = {
        SilentAim = false,
        DeadCheck = true,
...
-- ███████████████████████████████████████████████████████
-- СПЕЦИФИЧНЫЕ ДЛЯ PROJECT DELTA ФУНКЦИИ
-- ███████████████████████████████████████████████████████

-- Получение GameplayVariables игрока
